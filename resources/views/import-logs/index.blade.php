                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($importLogs as $log)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><a href="{{ asset('storage/'.$log->file_name) }}" target="_blank" class="text-prabhu-red-600 hover:text-prabhu-red-900">{{ basename($log->file_name) }}</a></td>
