                    ...
                    <form method="POST" action="{{ route('branches.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="district_id" name="district_id" class="mt-1 block w-full border-gray-300 focus:border-prabhu-red-500 focus:ring-prabhu-red-500 rounded-md shadow-sm" required>
                                ...
                                @foreach ($districts as $district)
                                    <option value="{{ $district->district_id }}" {{ old('district_id') == $district->district_id ? 'selected' : '' }}>{{ $district->district_name }} ({{ $district->province->province_name }})</option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="fiscal_year" class="block mt-1 w-full" type="text" name="fiscal_year" :value="old('fiscal_year')" required placeholder="e.g. 2082-83" />
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="number_of_branch" class="block mt-1 w-full" type="number" name="number_of_branch" :value="old('number_of_branch', 0)" required min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="number_of_agents" class="block mt-1 w-full" type="number" name="number_of_agents" :value="old('number_of_agents', 0)" required min="0" />
                            ...
                            <div>
                                ...
                                <x-text-input id="number_of_surveyors" class="block mt-1 w-full" type="number" name="number_of_surveyors" :value="old('number_of_surveyors', 0)" required min="0" />
