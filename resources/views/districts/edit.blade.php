                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('districts.update', $district->district_id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="province_id" name="province_id" class="mt-1 block w-full border-gray-300 focus:border-prabhu-red-500 focus:ring-prabhu-red-500 rounded-md shadow-sm" required>
                                ...
                                @foreach ($provinces as $province)
                                    <option value="{{ $province->province_id }}" {{ old('province_id', $district->province_id) == $province->province_id ? 'selected' : '' }}>{{ $province->province_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="district_name" class="block mt-1 w-full" type="text" name="district_name" :value="old('district_name', $district->district_name)" required autofocus />
