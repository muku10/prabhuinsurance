    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('complains.update', $complain->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="complain_type" class="block mt-1 w-full" type="text" name="complain_type" :value="old('complain_type', $complain->complain_type)" required autofocus />
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="pending_num" class="block mt-1 w-full" type="number" name="pending_num" :value="old('pending_num', $complain->pending_num)" required min="0" />
